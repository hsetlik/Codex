...
namespace Persistence.Migrations
{
    ...
    [Migration("20211103021142_SeededData")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.DataObjects.Term", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Domain.DataObjects.UserTerm", b =>
                {
                    ...
                    b.Property<string>("UserLanguageProfileUserId")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("CodexUserId");

                    b.HasIndex("TermId");

                    b.HasIndex("UserLanguageProfileUserId");
            ...
            modelBuilder.Entity("Domain.DataObjects.Translation", b =>
                {
                    b.HasOne("Domain.DataObjects.UserTerm", null)
            ...
            modelBuilder.Entity("Domain.DataObjects.UserTerm", b =>
                {
                    b.HasOne("Domain.DataObjects.CodexUser", "CodexUser")
                        .WithMany()
                        .HasForeignKey("CodexUserId");

                    b.HasOne("Domain.DataObjects.Term", "Term")
                        .WithMany()
                        .HasForeignKey("TermId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.DataObjects.UserLanguageProfile", null)
                        .WithMany("UserTerms")
                        .HasForeignKey("UserLanguageProfileUserId");

                    b.Navigation("CodexUser");
